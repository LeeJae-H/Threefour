...
public class PostRepositoryTest {
    ...
    void savePostTest() {
        ...
        assertThat(savedPost.getAuthor().getUserId()).isEqualTo(post.getAuthor().getUserId());
    ...
    void findPostByIdTest() {
        ...
        assertThat(foundPost.get().getAuthor().getUserId()).isEqualTo(savedPost.getAuthor().getUserId());
    ...
    @Test
    @DisplayName("작성자의 모든 게시글 삭제")
    void deletePostByAuthorTest() {
        Post post1 = createTestPostInstance();
        Post post2 = createTestPostInstance();
        Long userId = post1.getAuthor().getUserId();
    ...
    private Post createTestPostInstance() {
        ...
        return Post.writePost(userId, category, title, content);
    }
}